// Package cli assembles the ebay command tree from the ebay
...
// NewApp assembles the kit application from the ebay domain. The
...
//
// To add a command, declare it in ebay/domain.go with kit.Handle and it
// appears here automatically. Reach for app.AddCommand only for a verb that does
// not fit the emit-records shape, the way version does below.
func NewApp() *kit.App {
	id := ebay.Domain{}.Info().Identity
	id.Version = Version
