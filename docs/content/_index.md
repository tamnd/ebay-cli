---
title: "ebay"
description: "ebay reads public eBay data (search, items, sellers, categories, deals, autocomplete) into structured records over a CLI, an HTTP server, and an MCP tool set."
heroTitle: "ebay, from the command line"
heroLead: "Read public eBay listings, items, sellers, categories, and deals into structured records. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
ebay links <path>           # the pages it links to, each addressable
...
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address ebay as
  `ebay://` URIs and follow links across sites. See
