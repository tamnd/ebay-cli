...
Most of these come down to network reality or how ebay serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ebay rate-limits like any public site. ebay already paces
...
Where a surface is gated, ebay reads a cookie or token you supply
